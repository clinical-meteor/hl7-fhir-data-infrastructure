...
import Observations from './schemas/AllergyIntolerances';
import Patients from './schemas/AllergyIntolerances';
import Procedures from './schemas/AllergyIntolerances';
import ValueSets from './schemas/AllergyIntolerances';
        ...
        parsedResults.entry.forEach(function(entry){          
          if(get(entry, 'resource.resourceType')){
            ...
            if(Collections[collectionName]){
              // console.log(Collections[self.pluralizeResourceName(get(entry, 'resource.resourceType'))], Collections[self.pluralizeResourceName(get(entry, 'resource.resourceType'))].find().count())
              ...
              if(has(Meteor, 'default_connection')){
                ...
                //       //console.log('Couldnt find record; attempting to insert.')
                //       let newRecordId = Collections[collectionName].insert(newRecord, {validate: false, filter: false}, function(error){
                //         if(error) {
                //           console.log('window(self.pluralizeResourceName(entry.resource.resourceType))._collection.insert.error', error)
                //         }
                //       });   
