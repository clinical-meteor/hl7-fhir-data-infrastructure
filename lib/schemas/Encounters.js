...
EncounterSchemaR4 = new SimpleSchema({
  "resourceType" : {
    type: String,
    defaultValue: "Encounter"
  },
...
EncounterSchema = EncounterSchemaR4;
Encounters.attachSchema(EncounterSchema);


export { Encounters, Encounter, ncounterSchemaDstu2, EncounterSchema, EncounterSchemaStu3 }
