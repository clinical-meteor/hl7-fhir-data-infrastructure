...
const JsonToSimpleSchemaParser = function(fhirDefinition, resourceType) {
	...
	this.toSimpleSchemaProps = function toSimpleSchemaProps(resourceType) {
        ...
        console.log('toSimpleSchemaProps()');
        console.log('toSimpleSchemaProps().fhirDefinition', fhirDefinition);
	...
	this.generateSimpleSchema = function generateSimpleSchema(resourceType) {
        ...
        console.log('simpleSchemaProps', simpleSchemaProps);
	...
	function translateProperties(fhirDefinition, required, resourceType) {
        console.log('translateProperties()', fhirDefinition, required)
		...
		each(fhirDefinition, function(prop, key) {
            ...
            console.log('translateProperties().each().key', key)

            if(key === "definitions"){
                console.log('fhirDefinition().definitions', prop)
                console.log('fhirDefinition().definitions.' + resourceType, prop[resourceType])
            ...
            if(key === "definitions"){
                console.log('fhirDefinition().definitions.blackbox', blackbox)
            ...
            if(key === "definitions"){
                console.log('fhirDefinition().definitions.ssProp', ssProp)
            }
