...
// // HL7.Resources.RelatedPersons = new Mongo.Collection('HL7.Resources.RelatedPersons');

// if(typeof RelatedPersons === 'undefined'){
//   if(Package['clinical:autopublish']){
//     RelatedPersons = new Mongo.Collection('RelatedPersons');
//   } else if(Package['clinical:desktop-publish']){
//     RelatedPersons = new Mongo.Collection('RelatedPersons');
//   } else {
//     RelatedPersons = new Mongo.Collection('RelatedPersons', {connection: null});
//   }
// }
...
RelatedPersonR4 = new SimpleSchema({
  "_id" : {
    type: String,
    optional: true
  },
...
RelatedPersonSchema = RelatedPersonR4;
...
export { RelatedPerson, RelatedPersons, RelatedPersonSchema };
