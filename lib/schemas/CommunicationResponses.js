...
if(typeof CommunicationResponses === 'undefined'){
  ...
  //   CommunicationResponses = new Mongo.Collection('CommunicationResponses');
  // } else {
  //   CommunicationResponses = new Mongo.Collection('CommunicationResponses', {connection: null});
  // }
  CommunicationResponses = new Mongo.Collection('CommunicationResponses');
}
...
export { CommunicationResponse, CommunicationResponses, CommunicationResponseStu3, CommunicationResponseR4, CommunicationResponseSchema };