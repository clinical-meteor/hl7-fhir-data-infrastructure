...
OrganizationR4 = new SimpleSchema({
  "resourceType" : {
    type: String,
...
OrganizationSchema = OrganizationR4;
...
export default { Organization, Organizations, OrganizationSchema, OrganizationDstu2, OrganizationStu3, OrganizationR4 };
