...
// function VerificationResultDetail(props){
...
//                 value={get(verificationResult, 'title')}
...
//                 name="publisherInput"
//                 className={classes.input}
//                 value={get(verificationResult, 'publisher')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />       
//             </FormControl>      
...
//                 className={classes.input}
//                 placeholder="2020.2"              
//                 value={get(verificationResult, 'version')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />          
//             </FormControl>
...
//                 className={classes.input}
//                 placeholder="XYZ.1"              
//                 value={get(verificationResult, 'identifier[0].value')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />
//             </FormControl>     
...
//                 className={classes.input}
//                 placeholder="active"              
//                 value={get(verificationResult, 'status')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />    
//             </FormControl>
...
//                 className={classes.input}
//                 placeholder="Lorem ipsum."              
//                 value={get(verificationResult, 'description')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth           
//                 multiline   
//               />
...
// };
// ReactMixin(VerificationResultDetail.prototype, ReactMeteorData);
