...
function MessageHeaderDetail(props){
  ...
  let renderElements = [];
  let groups = get(messageHeader, 'group');
  ...
  let approvedOnDate = '';
  if(get(messageHeader, 'approvedDate')){
    approvedOnDate = moment(get(messageHeader, 'approvedDate')).format("YYYY-MM-DD")
  }
  let lastEditedDate = '';
  if(get(messageHeader, 'date')){
    lastEditedDate = moment(get(messageHeader, 'date')).format("YYYY-MM-DD")
  }
  let lastReviewDate = '';
  if(get(messageHeader, 'lastReviewDate')){
    lastReviewDate = moment(get(messageHeader, 'lastReviewDate')).format("YYYY-MM-DD")
  }


  return(
    <div className='MessageHeaderDetails'>
          ...
          <Grid item xs={6}>
            ...
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="publisherInput"
                className={classes.input}
                value={get(messageHeader, 'publisher')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />       
            </FormControl>      
          ...
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="2020.2"              
                value={get(messageHeader, 'version')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />          
            </FormControl>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="XYZ.1"              
                value={get(messageHeader, 'identifier[0].value')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />
            </FormControl>     
          ...
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="active"              
                value={get(messageHeader, 'status')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />    
            </FormControl>
          ...
          <Grid item xs={12}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="Lorem ipsum."              
                value={get(messageHeader, 'description')}
                //onChange={handleFhirEndpointChange}
                fullWidth           
                multiline   
              />
          ...
          <Grid item xs={6} style={{paddingLeft: '40px'}}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="editorInput"
                className={classes.input}            
                value={get(messageHeader, 'editor[0].name')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />
            </FormControl>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="reviewerInput"
                className={classes.input}
                value={get(messageHeader, 'reviewer[0].name')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />
            </FormControl>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="endorserInput"
                className={classes.input}         
                value={get(messageHeader, 'endorser[0].name')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />
            </FormControl>     
          ...
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="scoringInput"
                className={classes.input}              
                value={get(messageHeader, 'scoring.text')}
                fullWidth              
              />       
            </FormControl>        
          </Grid>
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="typeInput"
                className={classes.input}
                value={get(messageHeader, 'type[0].text')}
                fullWidth              
              />          
            </FormControl>   
          </Grid>
...
MessageHeaderDetail.propTypes = {
  id: PropTypes.string,
  fhirVersion: PropTypes.string,
  messageHeaderId: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
  messageHeader: PropTypes.oneOfType([PropTypes.object, PropTypes.bool]),
