...
//                 value={get(healthcareService, 'title')}
...
//                 name="publisherInput"
//                 className={classes.input}
//                 value={get(healthcareService, 'publisher')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />       
//             </FormControl>      
...
//                 className={classes.input}
//                 placeholder="2020.2"              
//                 value={get(healthcareService, 'version')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />          
//             </FormControl>
...
//                 className={classes.input}
//                 placeholder="active"              
//                 value={get(healthcareService, 'status')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth              
//               />    
//             </FormControl>
...
//                 className={classes.input}
//                 placeholder="Lorem ipsum."              
//                 value={get(healthcareService, 'description')}
//                 //onChange={handleFhirEndpointChange}
//                 fullWidth           
//                 multiline   
//               />
...
// };
// ReactMixin(HealthcareServiceDetail.prototype, ReactMeteorData);
