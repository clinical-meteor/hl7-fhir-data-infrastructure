...
function ClinicalImpressionDetail(props){
  ...
  return(
    <div className='ClinicalImpressionDetails'>
          ...
          <Grid item xs={6}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                value={get(clinicalImpression, 'title')}
            ...
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                name="publisherInput"
                className={classes.input}
                value={get(clinicalImpression, 'publisher')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />       
            </FormControl>      
          ...
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="2020.2"              
                value={get(clinicalImpression, 'version')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />          
            </FormControl>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="XYZ.1"              
                value={get(clinicalImpression, 'identifier[0].value')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />
            </FormControl>     
          ...
          <Grid item xs={3}>
            <FormControl style={{width: '100%', marginTop: '20px'}}>
              ...
              <Input
                ...
                className={classes.input}
                placeholder="active"              
                value={get(clinicalImpression, 'status')}
                //onChange={handleFhirEndpointChange}
                fullWidth              
              />    
            </FormControl>
...
ClinicalImpressionDetail.propTypes = {
  ...
  clinicalImpressionId: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
  clinicalImpression: PropTypes.oneOfType([PropTypes.object, PropTypes.bool]),
